...
public class MainActivity extends AppCompatActivity {
    ...
    CardView cvSekertariat, cvLakwas, cvTurbin, cvP2, cvP3, cvRiwayatLaporan;
    ...
    private void setInitLayout() {
        ...
        cvRiwayatLaporan = findViewById(R.id.cvRiwayatLaporan);
        ...
        cvRiwayatLaporan.setOnClickListener(v -> {
